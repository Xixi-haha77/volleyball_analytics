...
class CourtAnnotator(object):
    def __init__(self, filename: str, save_path: str):
        ...
        if annots is not None:
            ...
            self.h_top = tl[1]
            self.h_down = dr[1]
            print(self.w_tl, self.w_tr, self.w_dl, self.w_dr, self.h_top, self.h_down, '额外加的')
            ...
            print(self.net_top_left, self.net_down_left, self.net_top_right, self.net_down_right, '额外加的')
        ...
        print(self.att_top_left, '额外加的交点')
        self.root = Tk()
        ...
        print(self.pt1, self.pt2, self.pt3, self.pt4, '额外加的11')
